...
const Navigation = () => {
    ...
    return (
        ...
        <div className="bg-white flex justify-center items-center fixed w-full h-14 px-5 border-t border-secondary-200 bottom-0 md:h-[360px] lg:absolute lg:max-h-64 lg:w-[15%] lg:p-0  lg:top-40 lg:left-28 lg:rounded-lg lg:border-none">
