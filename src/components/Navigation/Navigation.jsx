...
const Navigation = () => {
    ...
    return (
        ...
        <div className="bg-white flex justify-center items-center fixed w-full h-14 px-5 border-t border-secondary-200 bottom-0 
        lg:absolute lg:h-[260px] lg:w-[15%] lg:p-0 lg:top-40 lg:left-28 lg:rounded-lg lg:border-none"
            style={{ zIndex: 9999 }}>
